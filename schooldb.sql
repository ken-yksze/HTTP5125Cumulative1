...
VALUES (1, 'Sarah', 'Valdez', 'N1678', '2018-06-18'),
...
INSERT INTO `studentsxcourses` (`studentxcoursid`, `studentid`, `courseid`)
VALUES (1, 1, 1),
  (2, 1, 2),
  (3, 1, 3),
  (4, 1, 4),
...
CREATE TABLE `teachers` (
  ...
  `teacherworkphone` char(15) DEFAULT NULL
) ENGINE = InnoDB DEFAULT CHARSET = latin1;
--
...
--
ALTER TABLE `students`
MODIFY `studentid` int(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  AUTO_INCREMENT = 33;
--
